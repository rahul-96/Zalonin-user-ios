...
class SalonsViewController: UIViewController {
    ...
    @IBAction func nextButtonPressed(){
        let homeTableViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "HomeTableViewController") as! HomeTableViewController
        homeTableViewController.selectedIndex = selectedIndex
...
extension SalonsViewController : CLLocationManagerDelegate {
...
extension SalonsViewController : GMSAutocompleteViewControllerDelegate {
